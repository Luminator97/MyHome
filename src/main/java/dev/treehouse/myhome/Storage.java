...
public class Storage {
    ...
    private String invitedBase(UUID t) { return "invited." + t; }
    ...
    public void deleteHome(UUID owner, String name) {
        ...
        // remove all invitations that reference this home
    ...
    public List<String> getPublicHomes() {
        ...
        for (String uStr : playersSec.getKeys(false)) {
            ...
            for (String name : getPublicList(u)) {
                if (hasHome(u, name)) out.add(u + ":" + name); // UUID:name
            }
        }
        return out;
    }
    ...
    /** Count only private homes for limit checks. */
